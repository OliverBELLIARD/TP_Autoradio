...
void SGTL5000_Init(void)
{
	...
	SGTL5000_i2c_WriteRegister(CHIP_LINREG_CTRL, 0x0008);     // Configure VDDD level to 1.2V
	SGTL5000_i2c_WriteRegister(CHIP_ANA_POWER, 0x7260);       // Power up internal linear regulator
	SGTL5000_i2c_WriteRegister(CHIP_REF_CTRL, 0x004E);        // Set reference voltage
	SGTL5000_i2c_WriteRegister(CHIP_LINE_OUT_CTRL, 0x0322);   // Configure line-out reference and bias
	SGTL5000_i2c_WriteRegister(CHIP_SHORT_CTRL, 0x1106);      // Enable short circuit detect
	SGTL5000_i2c_WriteRegister(CHIP_ANA_CTRL, 0x0133);        // Enable analog controls
	SGTL5000_i2c_WriteRegister(CHIP_DIG_POWER, 0x0073);       // Power up digital blocks
	SGTL5000_i2c_WriteRegister(CHIP_LINE_OUT_VOL, 0x0F0F);    // Set line-out volume
	*/
